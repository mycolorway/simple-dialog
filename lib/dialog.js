...
Dialog = (function(superClass) {
  ...
  Dialog.prototype._render = function() {
    ...
    this.el = $(Dialog._tpl.dialog).addClass([this.opts.cls, this.opts.defaultCls].join(' '));
  ...
  Dialog.prototype.refresh = function() {
    ...
    this.maxContentHeight || (this.maxContentHeight = (function(_this) {
      return function() {
        var buttonH, dialogMargin, dialogPadding, ref, titleH, winH;
        winH = $(window).height();
        dialogMargin = 30 * 2;
        dialogPadding = _this.wrapper.outerHeight() - _this.wrapper.height();
        titleH = $.contains(_this.contentEl[0], _this.titleEl[0]) ? _this.titleEl.outerHeight(true) : 0;
        buttonH = ((ref = _this.buttonWrap) != null ? ref.outerHeight(true) : void 0) || 0;
        return winH - dialogMargin - dialogPadding - titleH - buttonH;
      };
    })(this)());
