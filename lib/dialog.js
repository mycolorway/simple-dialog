  ...
  Dialog = (function(_super) {
    ...
    Dialog.prototype._render = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        $(this._button).addClass(button.cls).html(button.content).on("click", button.callback).appendTo(this.buttonWrap);
      }
        ...
        buttons: [
          {
            content: "知道了",
            callback: function(e) {
              return $(e.target).closest(".dialog").data("dialog").remove();
            }
          }
        ]
      });
